...
describe('ChefEtablissement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'chef-etablissement', component: ChefEtablissementComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.chefEtablissements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
