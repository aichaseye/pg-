...
class FileResourceIT {
    ...
    public static File createEntity(EntityManager em) {
        File file = new File().file(DEFAULT_FILE).fileContentType(DEFAULT_FILE_CONTENT_TYPE);
        return file;
    }
    ...
    public static File createUpdatedEntity(EntityManager em) {
        File file = new File().file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
        return file;
    }
    ...
    void putNewFile() throws Exception {
        ...
        updatedFile.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
    ...
    void partialUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE);
